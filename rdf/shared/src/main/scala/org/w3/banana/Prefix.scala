...
class LDPPrefix[Rdf <: RDF](ops: RDFOps[Rdf]) extends PrefixBuilder("ldp", "http://www.w3.org/ns/ldp#")(ops) {
  val Ascending = apply("Ascending")
  val BasicContainer = apply("BasicContainer")
  val Container = apply("Container")
  val Descending = apply("Descending")
  ...
  val Page = apply("Page")
  val PageSortCriterion = apply("PageSortCriterion")
  ...
  val PreferMinimalContainer = apply("PreferMinimalContainer")
  val RDFSource = apply("RDFSource")
  val Resource = apply("Resource")
  val constrainedBy = apply("constrainedBy")
  val contains = apply("contains")
  val hasMemberRelation = apply("hasMemberRelation")
  val inbox = apply("inbox")
  ...
  val pageSequence = apply("pageSequence")
  val pageSortCollation = apply("pageSortCollation")
  val pageSortCriteria = apply("pageSortCriteria")
  val pageSortOrder = apply("pageSortOrder")
  val pageSortPredicate = apply("pageSortPredicate")
