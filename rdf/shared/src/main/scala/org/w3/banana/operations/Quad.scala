...
/** A Quad is a structural description of what is used as a statement. A Statement is the expression
  * of a relation r, where r ∈ Subject ✖️ Predicate ✖️ Object triple. The same relation can appear
  * in any number of statements which is just a relation expressed somewhere (written down at some
  * place). Statement = Relation ✖️️️ Where ≅ (Subject ✖️ Predicate ✖️ Object) ✖️ Where ≅ Subject ✖️
  * Predicate ✖️ Object ✖️ Where
  * I.e. a statement is encoded as a quad. Interestingly enough a Statement can also be true or
  * false. It is true if that Relation was stated at that place.
  */
