...
abstract class NTriplesParserTest[M <: Module,E,X](val m: M, parser: NTriplesParser[M, String, E, X, Unit]) {
...
<http://www.w3.org/2001/sw/RDFCore/ntriples/> <http://purl.org/dc/elements/1.1/publisher> <http://www.w3.org/> ."""
    ...
    val parsedGraph = Graph(parser.ntriples(n3).get.asInstanceOf[Iterable[Triple]])
